...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Aditi C. Asundi — AI/ML Student Portfolio" },
      { property: "og:description", content: "Cute, elegant portfolio of Aditi — CSE (AI & ML) student, projects, skills and resume." },
